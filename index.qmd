...
Let's look at this two ways: all crops for each state, and each crop for all states. We'll start looking at each region:
...
I don't see a simple division between the ENSO-affected regions and the non-affected ones. Maybe it's time to look at the crop/ENSO relationship.
